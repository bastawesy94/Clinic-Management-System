...
public class DoctorLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("تسجيل دخول الطبيب");
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        ...
        try{
            ...
            String sql = "select * from clinic.doctor where name ='"+ UserName.getText() +"'and pass ='"+PassWord.getText()+"'";
            ...
            if(rs.next()){
                ...
                conn.close();
                stmt.close();
                setDefaultCloseOperation(DoctorLogin.EXIT_ON_CLOSE);
            }
            else
